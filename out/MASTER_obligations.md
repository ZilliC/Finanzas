# MASTER — Obligaciones del curso Finanzas 2632 (acumulado de las 20 clases)

> Se actualiza cada clase. Marca ✅ cuando cumplas/entregues.

## 💯 Esquema de evaluación — CERRADO (Clase 2)
| Componente | Peso | Notas |
|---|---|---|
| Exámenes | **40%** | Mín. 1, máx. 2 (prefiere 2), al final. Oral/escrito/teórico/práctico. |
| Trabajo de investigación | **30%** | Mín. 1, máx. 2, en equipo. |
| Participación | **20%** | Empiezas con 20%; −2% por cada respuesta incorrecta al azar. |
| Asistencia | **10%** | Requiere 100% asistencia (1 falta = pierdes el 10%). No se puede quitar. |

## Reglas permanentes
- [ ] Asistencia ≥ 80% (reglamento) — baja automática si no. · C1 [01:56], C2 [00:18]
- [ ] Asistencia 100% para conservar el 10%. · C2 [00:31]
- [ ] **Tolerancia 20 min** — al minuto 21 no entras (cuenta falta). · C2 [01:23]
- [ ] Participación: listo para preguntas al azar (clase anterior / temas asignados). · C1 [02:14], C2 [00:38]
- [ ] Calificación mínima 6.0 (5.5 no sube a 6). · C2 [00:19]

## Entregables
| Estado | Entregable | Detalle | Origen | Fecha límite |
|---|---|---|---|---|
| ⬜ | Trabajo de investigación #1 (equipo) | portada, índice, introducción, bibliografía; subir al **módulo/plataforma** en **3 formatos**; fecha/hora estrictas | C2 [00:45] | por confirmar |
| ⬜ | Trabajo de investigación #2 (equipo) | (si aplica; máx. 2) | C2 [00:43] | por confirmar |
| ⬜ | Exposición #1 (mismo tema del trabajo) | obligatoria; individual o parejas | C2 [00:52] | por confirmar |
| ⬜ | Exposición #2 | mínimo 2 exposiciones | C2 [00:52] | por confirmar |
| ⬜ | Examen(es) parcial/final | al final del curso | C2 [00:58] | por confirmar |
